...
const UserPost = ({ postDetails, userID }) => {
    console.log("UserPost received postDetails:", postDetails); // Debugging line
    ...
    useEffect(() => {
        if (Array.isArray(imageUrl)) {
            if (imageUrl.length > 1) setNumberOfImage(imageUrl.length);
            else {
                console.log("im here");
                setNumberOfImage(1);
            }
        ...
        <View style={styles.card}>
            ...
            <View style={styles.media}>
                ...
                <View style={styles.attribute}>
                    <CommentIcon size={20} color="white" oriCount={numberOfImage} iconType="image" />
                </View>
                {imageUrl && numberOfImage === 1 && <ImageComponent imageUrl={imageUrl} />}
                {imageUrl && numberOfImage > 1 && <CollageComponent images={imageUrl} />}
